...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <section>
            <div style="background-color: white" class="mainbox">
                <div style="color: #f36b2a" class="err">Error</div>
                <div style="margin-top:10px;color: #161c34;font-size:24px" class="msg">"${error}"</p></div>
            </div>
        </section>
        <!-- end section -->
        <!-- end section -->
